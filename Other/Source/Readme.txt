...
user in an INI file next to CLCLPortable.exe called CLCLPortable.ini.
...
copy CLCLPortable.ini from this directory to CLCLPortable.ini next to
CLCLPortable.exe. The options in the INI file are as follows:
